...
//TODO BUG
    ...
    // print('重大bug');
    // print(_mainController.uidCuttent.toString());
    // _userController.getUserWorkList(_mainController.uidCuttent.value);
  }
  ...
  _getSliverAppBar() {
    return SliverAppBar(
      ...
      pinned: true,
      expandedHeight: 200,
      leading: widget._isLoginUser
          ? null
          : IconButton(
              onPressed: () {
                widget._scrollPageController.animateToPage(0,
      ...
      actions: [
        IconButton(
          ...
          icon: Icon(
            widget._isLoginUser ? Icons.menu : Icons.more_horiz_rounded,
            color: Colors.white,
          ),
        ),
      ],
            ...
            child: TabBar(
              ...
              tabs: <Widget>[
                ...
                Tab(
                    child: Obx(
                  () => Text(
                    '喜欢 ${_userController.userInfoExResponse.value.likeCount.toString()}',
                  ),
                )),
              ],
              onTap: (index) {
