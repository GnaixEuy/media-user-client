...
class _LivingBottomWidgetState extends State<LivingBottomWidget> {
  ...
  void initState() {
    ...
    Timer.periodic(Duration(seconds: 1), (timer) {
      _scrollController.animateTo(40.0 * count,
  ...
  Widget build(BuildContext context) {
    double height =
        MediaQueryData.fromWindow(window).padding.top + 60 + 80 + 200;
    return Container(
      // color: Colors.red,
      ...
      child: Stack(
        children: [
          Positioned(bottom: 60, child: _getCommentLayout()),
          Positioned(bottom: 0, child: _getBottomBarLayout()),
          Positioned(bottom: 10, right: 10, child: _getHeaderLayout()),
        ],
      ),
    );
  }
          ...
          children: [
            Container(
              constraints: BoxConstraints(
                  minHeight: 40, minWidth: 40, maxWidth: 40, maxHeight: 40),
              decoration: BoxDecoration(
  ...
  _getCommentItem(int index) {
    ...
    return Container(
      ...
      margin:
          EdgeInsets.only(bottom: 5, left: 10, right: _getMarginRight(index)),
      decoration: BoxDecoration(
        color: Colors.black.withAlpha(50),
        borderRadius: BorderRadius.circular(20),
      ),
      child: Row(
        ...
        children: [
          Text(
            '${model.name}:',
            style: TextStyle(
                color: Color.fromARGB(255, 145, 230, 252),
        ...
        Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  '6/18',
                  style: TextStyle(color: ColorRes.color_3, fontSize: 14),
                ),
                SizedBox(
                  width: 2,
                ),
