...
class _MainPageBottomBarWidgetState extends State<MainPageBottomBarWidget> {
  ...
  _getLayoutBottomBar() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(flex: 1, child: _getAnimatedText('首页', 0)),
          // Expanded(
          //     flex: 1,
          ...
          // Expanded(flex: 1, child: _getAnimatedText('消息', 2)),
          Expanded(flex: 1, child: _getAnimatedText('我', 3)),
        ],
      ),
    );
  }
    ...
    return TextButton(
        ...
        child: Obx(
          () => Text(
            barName,
            style: TextStyle(
                color: mainPageScrollController.indexBottomBarMainPage.value ==
                        index
                    ? Colors.white
                    : Colors.grey,
                fontSize:
