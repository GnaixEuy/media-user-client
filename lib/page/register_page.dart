...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    accountField = TextField(
      ...
      cursorWidth: 2,
      decoration:
          InputDecoration(border: InputBorder.none, hintText: '请输入电话号码'),
      onChanged: (text) {
        account = text;
      },
    );
    ...
    pwdField = TextField(
      ...
      cursorWidth: 2,
      obscureText: true,
      decoration: InputDecoration(border: InputBorder.none, hintText: '请输入密码'),
      onChanged: (text) {
        pwd = text;
      },
    );
    ...
    pwdRepeatField = TextField(
      ...
      decoration: InputDecoration(
          border: InputBorder.none, hintText: '请输入短信验证码（等待接入随便输）'),
      onChanged: (text) {
        pwdRepeat = text;
      },
    );
