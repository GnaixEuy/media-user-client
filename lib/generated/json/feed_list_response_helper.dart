...
feedListListFromJson(FeedListList data, Map<String, dynamic> json) {
  ...
  if (json['createdDateTime'] != null) {
    data.createdDateTime = json['createdDateTime'] is String
...
feedListListContentFromJson(
    FeedListListContent data, Map<String, dynamic> json) {
  if (json['text'] != null) {
  ...
  if (json['attachments'] != null) {
    data.attachments = new List<FeedListListContentAttachments>();
    (json['attachments'] as List).forEach((v) {
      data.attachments.add(new FeedListListContentAttachments().fromJson(v));
    });
  }
  if (json['music'] != null) {
...
feedListListContentTagFromJson(
    FeedListListContentTag data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id'].toString();
  }
  if (json['name'] != null) {
...
Map<String, dynamic> feedListListContentTagToJson(
    FeedListListContentTag entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
...
feedListListContentAtFromJson(
    FeedListListContentAt data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id'].toString();
  }
  if (json['name'] != null) {
...
feedListListContentAttachmantsFromJson(
    FeedListListContentAttachments data, Map<String, dynamic> json) {
  if (json['type'] != null) {
    data.type = json['type'] is String
        ? int.tryParse(json['type'])
        : json['type'].toInt();
...
Map<String, dynamic> feedListListContentAttachmantsToJson(
    FeedListListContentAttachments entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['type'] = entity.type;
  data['url'] = entity.url;
...
feedListListContentMusicFromJson(
    FeedListListContentMusic data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id'].toString();
  }
  if (json['name'] != null) {
...
Map<String, dynamic> feedListListContentMusicToJson(
    FeedListListContentMusic entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
  data['name'] = entity.name;
  data['url'] = entity.url;
...
feedListListLocationFromJson(
    FeedListListLocation data, Map<String, dynamic> json) {
