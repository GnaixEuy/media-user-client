...
uploadTokenResponseFromJson(
    UploadTokenResponse data, Map<String, dynamic> json) {
  if (json['tokens'] != null) {
    data.tokens = new UploadTokenToken();
    data.tokens = new UploadTokenToken().fromJson(json["tokens"]);
  }
  return data;
}
...
uploadTokenTokenFromJson(UploadTokenToken data, Map<String, dynamic> json) {
  ...
  if (json['photoResultUrl'] != null) {
    data.photoResultUrl = json['photoResultUrl'].toString();
  }
  return data;
}
...
Map<String, dynamic> uploadTokenTokenToJson(UploadTokenToken entity) {
  ...
  data['photoResultUrl'] = entity.photoResultUrl;
...
uploadTokenTokensHeadersFromJson(
    UploadTokenTokensHeaders data, Map<String, dynamic> json) {
...
Map<String, dynamic> uploadTokenTokensHeadersToJson(
    UploadTokenTokensHeaders entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
