...
Map<String, dynamic> publishFeedRequestToJson(PublishFeedRequest entity) {
  ...
  print("device是" + entity.device);
  if (entity.device != null) {
    data['device'] = entity.device;
  }
  if (entity.aclType != null) {
    data['aclType'] = entity.aclType;
  }
  if (entity.commentType != null) {
...
publishFeedContentFromJson(PublishFeedContent data, Map<String, dynamic> json) {
  ...
  if (json['attachments'] != null) {
    data.attachments = new List<PublishFeedContentAttachments>();
    (json['attachments'] as List).forEach((v) {
      data.attachments.add(new PublishFeedContentAttachments().fromJson(v));
    });
  }
  if (json['music'] != null) {
...
publishFeedContentTagFromJson(
    PublishFeedContentTag data, Map<String, dynamic> json) {
  if (json['id'] != null) {
...
publishFeedContentAtFromJson(
    PublishFeedContentAt data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id'].toString();
  }
  if (json['name'] != null) {
...
publishFeedContentAttachmentsFromJson(
    PublishFeedContentAttachments data, Map<String, dynamic> json) {
  if (json['type'] != null) {
    data.type = json['type'] is String
        ? int.tryParse(json['type'])
        : json['type'].toInt();
...
Map<String, dynamic> publishFeedContentAttachmantsToJson(
    PublishFeedContentAttachments entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['type'] = entity.type;
  data['url'] = entity.url;
...
publishFeedContentMusicFromJson(
    PublishFeedContentMusic data, Map<String, dynamic> json) {
  if (json['id'] != null) {
    data.id = json['id'].toString();
  }
  if (json['name'] != null) {
...
Map<String, dynamic> publishFeedContentMusicToJson(
    PublishFeedContentMusic entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['id'] = entity.id;
  data['name'] = entity.name;
  data['url'] = entity.url;
...
publishFeedLocationFromJson(
    PublishFeedLocation data, Map<String, dynamic> json) {
